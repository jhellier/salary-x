!function() {
    ...
    var companyButtonColor = d3.scaleOrdinal(d3.schemeCategory20);
    ...
    var y = d3.scaleBand().rangeRound([ 0, height ], .1);
...
//    .attr("height",     height + margin.top + margin.bottom + 25)
    ...
    function make_x_axis20() {  
        return d3.axisBottom().scale(x).ticks(20);
    }
    ...
    function buildMainBarGraph() {
        ...
        // Uses .bar as the identifier. .bar does not have to exist. It
    ...
    var barColors = d3.scaleOrdinal(d3.schemeCategory20);
    ...
    function sortBy(sortColumn, label, isCost, colorStream) {
        ...
        .sort(function(a, b) { 
            //debugger;
            return y0(a.Company) - y0(b.Company); });
        ...
        xAxis = d3.axisBottom().scale(x).ticks(20);                 
